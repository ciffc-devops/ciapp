...
namespace WF_ICS_ClassLibrary.Models.GeneralModels
{
    public class ICSFormInformation
    {
        ...
        private string _FormNumberModifier;
        ...
        public string FormNumberWithModifier { get => $"{FormNumber}{(string.IsNullOrEmpty(FormNumberModifier) ? "" : $"{FormNumberModifier}")}"; }
        public string FormName { get => _FormName; set => _FormName = value; }
        public string NameWithNumber { get => $"{FormNumberWithModifier} - {FormName}"; }
        ...
        public string FormNumberModifier { get => _FormNumberModifier; set => _FormNumberModifier = value; }
