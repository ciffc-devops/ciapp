...
namespace WF_ICS_ClassLibrary.Models
{
    ...
    public class GeneralOptions
    {
        ...
        [ProtoMember(50)] private List<GearCategory> _AllEquipmentCategories = new List<GearCategory>();
        [ProtoMember(51)] private List<Gear> _AllEquipment = new List<Gear>();
        [ProtoMember(52)] private List<GearSet> _AllEquipmentSets = new List<GearSet>();
        ...
        public List<Gear> AllEquipment { get => _AllEquipment; set => _AllEquipment = value; }
        public List<GearSet> AllEquipmentSets { get => _AllEquipmentSets; set => _AllEquipmentSets = value; }
