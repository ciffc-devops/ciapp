...
namespace WF_ICS_ClassLibrary.Models
{
    public static class OrganizationalChartTools
    {
        ...
        public static void FillFromGenericRole(this ICSRole role, GenericICSRole genericRole)
        {
            ...
            role.PDFFieldName = genericRole.PDFFieldName;
        }
        ...
        public static List<ICSRole> GetRolesForAssignmentList(this OrganizationChart org, Guid SectionID, int maxDepth = 0, int MaxCount = 0)
        {
            ...
            foreach (ICSRole role in org.ActiveRoles.Where(o => o.SectionID == SectionID))
            {
                ...
                if (maxDepth > 0) { childRoles = childRoles.Where(o => o.SectionID == SectionID && o.Depth <= maxDepth).ToList(); }
            ...
            if (MaxCount > 0 && roles.Count > MaxCount && (maxDepth > 1))
            {
                ...
                roles = org.GetRolesForAssignmentList(SectionID, newDepth, MaxCount);
            }
        ...
        public static List<GenericICSRole> GetGenericICSRoles(Guid SectionID = new Guid())
        {
            ...
            roles.Add(new GenericICSRole() { GenericRoleID = new Guid("1096905E-A726-41D8-A8BC-2EAD61CCB2F7"), RoleName = "Incident Commander", ReportsToGenericRoleID = Globals.IncidentCommanderGenericID, SectionID = Globals.IncidentCommanderGenericID, MnemonicAbrv = "ICT", RoleDescription = "The person responsible for all incident activities, including the development of strategies and tactics and the ordering and release of resources. The IC has overall authority and responsibility for conducting incident operations and is responsible for the management of all incident operations at the incident site.", RoleNameWithPlaceholder = "", OnInitialOrgChart = true, PDFFieldName = "IncidentCommander", RequiresOperationalGroup = false, ManualSortOrder = 0 });
            ...
            roles.Add(new GenericICSRole() { GenericRoleID = new Guid("ad9ff46e-b1f1-4327-8303-2cbdd22322a5"), RoleName = "Information Officer", ReportsToGenericRoleID = Globals.IncidentCommanderGenericID, SectionID = Globals.IncidentCommanderGenericID, MnemonicAbrv = "IOF", RoleDescription = "A member of the Command Staff responsible for interfacing with internal clients, the public and media and/or with other agencies with incident related information requirements", RoleNameWithPlaceholder = "", OnInitialOrgChart = true, PDFFieldName = "Text2", RequiresOperationalGroup = false, ManualSortOrder = 1 });


            roles.Add(new GenericICSRole() { GenericRoleID = new Guid("9ba31b81-84c0-49f5-bf19-49973ff0e972"), RoleName = "Liaison Officer", ReportsToGenericRoleID = Globals.IncidentCommanderGenericID, SectionID = Globals.IncidentCommanderGenericID, MnemonicAbrv = "LOFR", RoleDescription = "A member of the Command Staff responsible for coordinating with representatives from cooperating and assisting agencies or organizations.", RoleNameWithPlaceholder = "", OnInitialOrgChart = true, PDFFieldName = "LiaisonOfficer", RequiresOperationalGroup = false, ManualSortOrder = 2 });
            roles.Add(new GenericICSRole() { GenericRoleID = new Guid("CE7166AF-9432-4F7A-B942-1250AF0B7C31"), RoleName = "Safety Officer", ReportsToGenericRoleID = Globals.IncidentCommanderGenericID, SectionID = Globals.IncidentCommanderGenericID, MnemonicAbrv = "SOF", RoleDescription = "A member of the command staff who is responsible for monitoring response operations and advising the Incident Commander on all matters related to the safety of operations, including the health and safety of personnel.", RoleNameWithPlaceholder = "", OnInitialOrgChart = true, PDFFieldName = "SafetyOfficer", RequiresOperationalGroup = false, ManualSortOrder = 3 });
